...
protected:
	...
	//加载机器
	bool OnRequestLoadAndroidUser(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID, DWORD lastLoadId = 0, DWORD timePoint = -1);
	//加载道具
...
protected:
	...
	// 查询牌局数
	bool OnRequestQueryGameCount(DWORD dwContextID, VOID * pData, WORD wDataSize);
